...
public class ManageCategories extends javax.swing.JFrame {
    ...
    public ManageCategories() {
        ...
        fetchCategories(searchQuery, pageNumber);
    }
    ...
    public ManageCategories(ManageProducts manageProducts) {
    ...
    private void initComponents() {
        ...
        tableCategories.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jScrollPane1.setViewportView(tableCategories);
        if (tableCategories.getColumnModel().getColumnCount() > 0) {
            tableCategories.getColumnModel().getColumn(0).setMinWidth(40);
            tableCategories.getColumnModel().getColumn(0).setPreferredWidth(40);
            tableCategories.getColumnModel().getColumn(0).setMaxWidth(40);
            tableCategories.getColumnModel().getColumn(1).setResizable(false);
            tableCategories.getColumnModel().getColumn(2).setMinWidth(0);
            tableCategories.getColumnModel().getColumn(2).setPreferredWidth(0);
            tableCategories.getColumnModel().getColumn(2).setMaxWidth(0);
        }

        labelCategories.setFont(new java.awt.Font("Poppins", 0, 18)); // NOI18N
        labelCategories.setText("Categories");

        btnAddCategories.setBackground(new java.awt.Color(0, 153, 255));
        btnAddCategories.setFont(new java.awt.Font("Poppins", 0, 14)); // NOI18N
        btnAddCategories.setForeground(new java.awt.Color(255, 255, 255));
        btnAddCategories.setText("Add Data");
        btnAddCategories.setBorder(null);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(btnAddCategories, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(btnAddCategories, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public void btnAddCategoriesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCategoriesActionPerformed
        JDialog addCategoryDialog = new JDialog(this, "Add New Category", true);
        ...
        JTextField txtCategoryName = new JTextField(20); // Set preferred width for the input field
        ...
        addCategoryDialog.add(inputPanel, BorderLayout.CENTER);
        ...
        btnSave.addActionListener(e -> {
            ...
            if (categoryName.isEmpty()) {
                JOptionPane.showMessageDialog(addCategoryDialog, "Category name cannot be empty.", "Validation Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            try (PreparedStatement ps = conn.prepareStatement("INSERT INTO categories (name) VALUES (?)")) {
                ...
                ps.executeUpdate();
                JOptionPane.showMessageDialog(addCategoryDialog, "Category added successfully!");
                addCategoryDialog.dispose(); // Close the dialog

                // Refresh categories based on the search query
                if (manageProducts != null) {
                    manageProducts.productFetchCategories();  // Refresh the combo box in ManageProducts
                } else {
                    String searchQuery = txtSearch.getText().trim();
                    int pageNumber = 0; // Set the current page (0 for the first page)
                    fetchCategories(searchQuery, pageNumber);
                ...
                JOptionPane.showMessageDialog(addCategoryDialog, "Error adding category: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
        });

        // Handle Cancel button
        btnCancel.addActionListener(e -> addCategoryDialog.dispose());

        addCategoryDialog.setLocationRelativeTo(this); // Center dialog
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        if (selectedRow != -1) {
            // Retrieve the category ID from the hidden column (index 2)
            int id = getSelectedCategoryId();  // ID from the hidden column

            // Retrieve the category name from the visible column (index 1)
            String categoryName = (String) model.getValueAt(selectedRow, 1);  // Name from the second column

            // Retrieve the current search query
            String searchQuery = txtSearch.getText().trim();  // Get search query from the text field

            // Call the editCategory method with ID, Name, and searchQuery
            editCategory(id, categoryName, searchQuery);  // Pass both ID, Name, and search query
        } else {
            JOptionPane.showMessageDialog(this, "Please select a category first.", "No Selection", JOptionPane.WARNING_MESSAGE);
        }// TODO add your handling code here:
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (id != -1) {
            String searchQuery = txtSearch.getText().trim();
            deleteCategory(id, searchQuery); // Your edit method
        }// TODO add your handling code here:
    ...
    private void txtSearchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtSearchKeyReleased
        ...
        if (!searchQuery.isEmpty()) {
            fetchCategories(searchQuery, pageNumber);  // Call a method to fetch filtered categories
        } else {
            fetchCategories(searchQuery, pageNumber);  // If the search field is empty, fetch all categories
        }// TODO add your handling code here:
    ...
    private void btnPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrevActionPerformed
        if (currentPage > 0) {
            currentPage--;
            fetchCategories(txtSearch.getText().trim(), currentPage);
        }// TODO add your handling code here:
    ...
    private void fetchCategories(String searchQuery, int pageNumber) {
        int offset = pageNumber * pageSize; // Offset for pagination

        String sql = "SELECT id, name FROM categories WHERE name LIKE ? LIMIT ? OFFSET ?";
    ...
    private int getSelectedCategoryId() {
        ...
        if (model.getColumnCount() > 2) {
            ...
            Object categoryIdObject = model.getValueAt(selectedRow, 2);
            if (categoryIdObject instanceof Integer) {
                return (int) categoryIdObject; // Return the category ID
            } else {
                JOptionPane.showMessageDialog(this, "Invalid category ID format.", "Error", JOptionPane.ERROR_MESSAGE);
                return -1;
            }
        } else {
    ...
    private void deleteCategory(int id, String searchQuery) {
        int confirm = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete this category?", "Confirm Delete", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
    ...
    private void editCategory(int id, String categoryName, String searchQuery) {
        // Create a JPanel for the custom dialog
        JPanel panel = new JPanel(new GridLayout(2, 1));
        JLabel lblCategoryName = new JLabel("Edit Category Name:");
        JTextField txtCategoryName = new JTextField(categoryName);  // Set the default text to categoryName
        panel.add(lblCategoryName);
        panel.add(txtCategoryName);

        // Show the custom dialog without any icon
        int option = JOptionPane.showConfirmDialog(this, panel, "Edit Category", JOptionPane.OK_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE);
        ...
        if (option == JOptionPane.OK_OPTION) {
            ...
            if (!newCategoryName.isEmpty()) {
                try (PreparedStatement ps = conn.prepareStatement("UPDATE categories SET name = ? WHERE id = ?")) {
                    ...
                    int pageNumber = 0; // Set the current page (0 for the first page)
                    fetchCategories(searchQuery, pageNumber);  // Refresh table
                    updatePrevNextButtons();
                } catch (SQLException ex) {
    ...
    private void customizeTable() {
        ...
        tableCategories.setFont(tableFont);  // Apply to the table cells
        ...
        tableCategories.setRowHeight(30);  // Set a larger row height if needed
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    public javax.swing.JButton btnAddCategories;
