...
public final class Input extends javax.swing.JFrame {
    ...
    private void menuData11MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_menuData11MouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_menuData11MouseEntered
    ...
    private void showProductModal(String initialSearchQuery) {
        ...
        Runnable fetchProducts = () -> {
            ...
            String sql = "SELECT barcode, products.name AS product, categories.name AS category, stocks, sell_price "
                    ...
                    + "WHERE (products.name LIKE ? OR barcode LIKE ? OR categories.name LIKE ?) " // Inner refinement
                    + "AND (products.name LIKE ? OR barcode LIKE ? OR categories.name LIKE ?) " // Outer limitation
                    + "LIMIT ? OFFSET ?";
        ...
        txtPayment.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                try {
                    ...
                    ((AbstractDocument) changeAmount.getDocument()).setDocumentFilter(new CurrencyFilter());
